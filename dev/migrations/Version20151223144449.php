 ...
 */
class Version20151223144449 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE examination (id INT AUTO_INCREMENT NOT NULL, questions LONGTEXT NOT NULL, totalQuestions INT NOT NULL, usersInput LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json_array)\', correctAnswersCount INT DEFAULT NULL, totalTime INT NOT NULL, created DATETIME DEFAULT CURRENT_TIMESTAMP, completed DATETIME DEFAULT NULL, isQualified TINYINT(1) NOT NULL, userId INT NOT NULL, INDEX IDX_CCDAABC564B64DCC (userId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE examination ADD CONSTRAINT FK_CCDAABC564B64DCC FOREIGN KEY (userId) REFERENCES users (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE examination DROP FOREIGN KEY FK_CCDAABC564B64DCC');
